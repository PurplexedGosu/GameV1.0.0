    ...
    */
    ...
    public void ninjaDied()
    {
        if (ninjahp <= 0)
        {
            ...
            {
                this.setHP(this.getArmor());
                Greenfoot.setWorld(new K1(this));
            }
            ...
            if (getWorld() instanceof Intro0)
            {
                this.setHP(this.getArmor());
                Greenfoot.setWorld(new Intro0(this));
            }
            if (getWorld() instanceof Intro1)
            {
                this.setHP(this.getArmor());
                Greenfoot.setWorld(new Intro1(this));
            }
            if (getWorld() instanceof Intro2)
            {
                this.setHP(this.getArmor());
                Greenfoot.setWorld(new Intro2(this));
            }
            if (getWorld() instanceof Intro3)
            {
                this.setHP(this.getArmor());
                Greenfoot.setWorld(new Intro3(this));
            }
            if (getWorld() instanceof Intro4)
            {
                this.setHP(this.getArmor());
                Greenfoot.setWorld(new Intro4(this));
            }
            if (getWorld() instanceof Intro5)
            {
                this.setHP(this.getArmor());
