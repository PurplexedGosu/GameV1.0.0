...
public class Kyobashi extends Trap
{
    ...
    private void prepare()
    {
        ...
        addObject(swordicon, 85, 558);
        ShurikenIcon shurikenicon = new ShurikenIcon();
        addObject(shurikenicon, 190, 530);
        shurikenicon.setLocation(190, 530);
        shurikenicon.setLocation(190, 530);
        shurikenicon.setLocation(190, 530);
        shurikenicon.setLocation(190, 530);
        shurikenicon.setLocation(190, 530);
        ...
        shurikenicon.setLocation(190, 530);
        shurikenicon.setLocation(190, 530);
        shurikenicon.setLocation(32, 557);
        swordicon.setLocation(209, 558);
        shurikenicon.setLocation(72, 550);
        swordicon.setLocation(127, 550);
}
