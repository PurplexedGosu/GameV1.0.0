...
public class K3 extends Trap
{
    ...
    private void prepare()
    {
        ...
        BlackRM blackrm = new BlackRM(2, 2);
        addObject(blackrm, 521, 134);
        BlackRM blackrm2 = new BlackRM(2, 2);
        ...
        BlackMM blackmm = new BlackMM(2, 1);
        addObject(blackmm, 159, 492);
        BlackMM blackmm2 = new BlackMM(2, 1);
        addObject(blackmm2, 609, 494);
        BlackRM blackrm3 = new BlackRM(2, 1);
        addObject(blackrm3, 335, 617);
        BlackRM blackrm4 = new BlackRM(2, 1);
        addObject(blackrm4, 459, 620);
        BlackRM blackrm5 = new BlackRM(2, 1);
        addObject(blackrm5, 305, 394);
        BlackRM blackrm6 = new BlackRM(2, 1);
